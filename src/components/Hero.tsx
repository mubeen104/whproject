...
const Hero = () => {
  ...
  return <section id="hero" className="relative bg-background min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="absolute top-40 left-10 w-12 h-12 bg-accent/20 rounded-full animate-bounce" style={{
      animationDelay: '0.5s'
    }} />
      <div className="absolute bottom-32 right-32 w-16 h-16 bg-primary/5 rounded-full animate-pulse" style={{
      animationDelay: '1s'
    }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex items-center space-x-8 animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
            ...
            animationDelay: '0.4s'
              ...
              <Button size="lg" className="group bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105" asChild>
                <a href="/shop">
                  Shop Now
              ...
              <Button size="lg" variant="outline" className="group border-2 border-primary/20 text-foreground hover:border-primary hover:bg-primary/5 transition-all duration-300 hover:scale-105" asChild>
                <a href="/contact">
                  Learn More
          ...
          <div className="relative lg:block animate-scale-in" style={{
          animationDelay: '0.8s'
        }}>
            <div className="relative group">
              {/* Main Image with Hover Effect */}
              <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                <img src={heroImage} alt="Natural herbal products" className="w-full h-[550px] object-cover group-hover:scale-105 transition-transform duration-700" />
              ...
              <div className="absolute -top-4 -left-4 bg-card border border-border shadow-lg rounded-xl p-4 animate-bounce" style={{
              animationDelay: '1s'
            }}>
              ...
              {/* Floating Stats Card */}
              <div className="absolute -bottom-6 -right-6 bg-card border border-border shadow-xl rounded-xl p-6 animate-fade-in" style={{
              animationDelay: '1.2s'
            }}>
